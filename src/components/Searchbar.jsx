...
const Searchbar = ({HandleFormSubmit,SearchRecipe,HandleSearchChange}) => {
  return (
    <div>
...
className="max-w-md mx-auto">   
    ...
    <div className="relative">
        ...
        type="search"
         id="default-search"
          className="block w-full p-4 ps-10 text-sm  border-gray-300 rounded-lg bg-gray-50 border-2 border-solid focus:ring-blue-500 focus:border-blue-500  "
